...
def get_final_csv(ml_pre_dict, av_agent_final_1, av_agent_final_2, av_agent_final_3):
    # 加载三个CSV文件
    csv_files = []
    agent_names = []

    for i, agent_path in enumerate([av_agent_final_1, av_agent_final_2, av_agent_final_3]):
...
if __name__ == '__main__':
    ...
    final_1= 'av_agent_final_1'
    final_2= 'av_agent_final_2'
    final_3= 'av_agent_final_3'
    final_4= 'av_agent_final_4'


    seqs_test = test001.load_seqs_from_file(test_file)


    # seqs_test=seqs_test[:2]
    ...
    # #调用llm推理
    # # xml
    test004_1.main(seqs_test, output_dir, final_1, llm_name)
    #+risky method
    test004_2.main(seqs_test, output_dir, final_2, llm_name)
    #+特征
    test004_3.main(seqs_test, output_dir, final_3, llm_name)
    #全部
    test004_4.main(seqs_test, output_dir, final_4, llm_name)


    get_pre_result(final_1, final_2, final_3)
    get_pre_result_one(final_4)
    get_final_csv(ml_pre_dict, final_1, final_2, final_3)
