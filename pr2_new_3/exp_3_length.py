...
if __name__ == '__main__':
    ...
    for len in [32,64,128,256,512,1024,2048,4096,8192,16384,32768]:
        t=None
        if len==32:
            test002.main(seqs_train)#可疑代码提取
            test003.main(seqs_train,output_dir,llm_name)#模板生成
            # 生成测试集模板
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            # 所有任务列表
            tasks = [
                (test004_1.main, seqs_train, output_dir, view_train_1, llm_name, t, len),
                (test004_2.main, seqs_train, output_dir, view_train_2, llm_name, t, len),
                (test004_3.main, seqs_train, output_dir, view_train_3, llm_name, t, len),
                (test004_1.main, seqs_test, output_dir, view_test_1, llm_name, t, len),
                (test004_2.main, seqs_test, output_dir, view_test_2, llm_name, t, len),
                (test004_3.main, seqs_test, output_dir, view_test_3, llm_name, t, len),
            ]
        ...
        print(['llm-result 长度：',len,balance_accuracy_llm, precision_llm, recall_llm, f1_value_llm])
