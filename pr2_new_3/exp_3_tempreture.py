...
if __name__ == '__main__':
    ...
    for t in [0,0.2,0.4,0.6,0.8,1,1.2,1.4,1.6,1.8,2]:#[0,0.2,0.4,0.6,0.8,1,1.2,1.4,1.6,1.8,2]
        # if t==0:
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            # 所有任务列表
            tasks = [
                (test004_1.main, seqs_train, output_dir, view_train_1, llm_name, t),
                (test004_2.main, seqs_train, output_dir, view_train_2, llm_name, t),
                (test004_3.main, seqs_train, output_dir, view_train_3, llm_name, t),
                (test004_1.main, seqs_test, output_dir, view_test_1, llm_name, t),
                (test004_2.main, seqs_test, output_dir, view_test_2, llm_name, t),
                (test004_3.main, seqs_test, output_dir, view_test_3, llm_name, t),
            ]
        ...
        print(['llm-result 温度：',t,balance_accuracy_llm, precision_llm, recall_llm, f1_value_llm])
